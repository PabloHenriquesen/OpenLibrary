...
public class ConteudoDAO {
        ...
        public void Salvar(Connection conn, ConteudoDTO conteudo) throws SQLException {
            ...
            try (PreparedStatement stmt = conn.prepareStatement(sql)) {
                ...
                stmt.setDate(4, java.sql.Date.valueOf(conteudo.getLancamento()));
        ...
        public List<ConteudoDTO> PesquisarTodos(Connection conn) throws SQLException {
            String sql = "SELECT id, usuario, titulo, lancamento, descricao, imagem, tipo FROM conteudo order by postagem desc";
